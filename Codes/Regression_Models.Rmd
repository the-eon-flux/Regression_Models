...
knots <- c(mean(mtcars$disp), sd(mtcars$disp))
splineTerms <- sapply(knots, function(knot){ifelse(mtcars$disp - knot > 0, mtcars$disp - knot, 0) })
...
plot(mtcars$disp, mtcars$qsec, pch = 16, xlab = "Displacement", ylab = "qsec (1/4 mile time)" )
lines(mtcars$disp, yhat, lwd = 2, col = "dodgerblue")
abline(lm(qsec ~ disp, mtcars), lwd= 2, col="red")
