...
* **Consequences of results**
  ...
  * The line passes through the point $(\bar X, \bar Y$) ; Proof > rearrange the eq. of $ \beta_0$ to $ \bar Y = \hat \beta_0 + \hat \beta_1 \bar X$). Once we plug in value of $\bar X$ into the equation of the fitted line we get $\bar Y$ out.
...
### Slope of regression through the origin = Linear regression without 0 intercept if X & Y were mean centered.
